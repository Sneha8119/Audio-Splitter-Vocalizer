...
# Limit GPU memory growth to prevent TensorFlow from using all available GPU memory
...
def separate_audio():
    ...
    if audio_file and output_directory:
        ...
        try:
            ...
            result_label.configure(text=f"Audio separation completed.\nSeparated files saved in {output_directory}")
...
if __name__ == "__main__":
    ...
    root.title("Vocalizer - Audio Splitter")
    ...
    audio_entry = tk.CTkEntry(master=frame, width=300)
    ...
    output_entry = tk.CTkEntry(master=frame, width=300)
